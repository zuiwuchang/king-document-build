...
(a=u.html(),v.ShowPreview(a)):(k.html(""),k.hide(),q.show())});l.find(".glyphicon-registration-mark:first").click(function(a){J.Show()});l.find(".glyphicon-copyright-mark:first").click(function(b){m.Show(a["input code"],"",function(a,b){a.Hide();""!=b&&(b="\n<pre class='prettyprint linenums'>"+E(b)+"</pre>",u.push(b),t=u.html(),k.html(t),v.UpdateStatus(t),prettyPrint())})});l.find(".glyphicon-save:first").click(function(a){a=u.html();v.Save(a)});l.find(".glyphicon-picture:first").click(function(a){y.loadPlugin("image",
